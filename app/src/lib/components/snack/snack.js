...
/**
 * @typedef {import("svelte/store").Writable<import("$lib/types/snack").SnackInstance>} WritableInstance
 * @typedef {import("svelte/store").Readable<import("$lib/types/snack").SnackInstance>} ReadableInstance
 * @typedef {{ [key: symbol]: import("$lib/types/snack").InstanceMapEntry }} InstanceMap
 *
...
/**
 * @param {import("$lib/types/snack").SnackInstance} instance
 */
export function pushToSnackStack(instance) {
	const id = Symbol();
	const writableInstance = writable(instance);

	/** @type {import("$lib/types/snack").SnackInstanceUpdater} */
