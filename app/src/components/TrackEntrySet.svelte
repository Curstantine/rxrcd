<script>
	import TrackItem from "@/components/items/TrackItem.svelte";
	import TrackItemSkeleton from "@/components/items/TrackItemSkeleton.svelte";

	/** @type {import("@/types/deezer").Track[] | null}*/
	export let tracks;
</script>
